...
import logoImg from "/placeholder.svg";
import heroFormImg from "/placeholder.svg";
import fileIcon from "/file.svg";
import tIcon from "/placeholder.svg";
import chromeIcon from "/placeholder.svg";
import settingsIcon from "/placeholder.svg";
import checkIcon from "/placeholder.svg";
import form from "/placeholder.svg";
import driveIntegration from "/placeholder.svg";
import settingsLanding from "/placeholder.svg";
import teamSettingsLanding from "/placeholder.svg";
    ...
    <div className={styles.landing}>
      ...
      >
        ...
        <div className={styles.heroForm}>
          <img
            src={heroFormImg || "/placeholder.svg"}
            alt="Hero form UI"
      ...
      >
        ...
        <div className={`${styles.block} ${styles.blue}`}>
          ...
          <p>
            Stop wasting time in Meta Ads Manager's clunky interface. Simply
            select your ideal settings once. We take care of the rest.
          </p>
        </div>
      </motion.section>
      ...
      >
        <div className={styles.persistentContent}>
          ...
          <h3>
            Persistent Settings<br></br> Per Account
          </h3>
          <p>
            UTMs, page selections, ad name formulas,<br></br>all saved, per ad
            account, so nothing resets<br></br> on reload.
          </p>
        </div>
        <img
          src={settingsLanding}
          alt="Persistent Settings Screenshot"
          className={styles.settingsLanding}
        />
      </motion.section>
      ...
      >
        <div className={styles.publishCard}>
          ...
          <p>
            No need to spend hours downloading hundreds of ad assets. With Blip,
            you can one-click deploy media from your Drive to Meta Ads Manager.
          </p>
        </div>
        <img
          src={driveIntegration}
          alt="Google Drive Integration Screenshot"
          className={styles.driveIntegration}
        />
      </motion.section>
      ...
      >
        <div className={styles.teamContent}>
          ...
          <h3>
            Team seats<br></br> Coming Soon
          </h3>
          <p>
            Stop wasting time in Meta Ads Manager's <br></br>clunky interface.
            Automate your ad creation flow<br></br> with lightning-fast bulk
            uploads, saved settings,<br></br> and ad previews — all in one clean
            dashboard.
          </p>
        </div>
        <img
          src={teamSettingsLanding}
          alt="Team Seats Screenshot"
          className={styles.teamSettingsLanding}
        />
      </motion.section>
        ...
        <div className={styles.footerContent}>
          <div className={styles.footerLeft}>
            ...
            <div className={styles.footerEmail}>
              <a href="mailto:shree@withblip.com"> shree@withblip.com</a>
            </div>
          </div>
